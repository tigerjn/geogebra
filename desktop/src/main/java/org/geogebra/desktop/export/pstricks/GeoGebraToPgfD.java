...
public class GeoGebraToPgfD extends GeoGebraToPgf {
	...
	protected GGraphics2D createGraphics(FunctionalNVar ef,
		...
		return new InequalityPlotGraphicsPgf(ef, inequality);
	}

	class InequalityPlotGraphicsPgf extends InequalityPlotGraphicsD {

		public InequalityPlotGraphicsPgf(FunctionalNVar geo, Inequality ineq) {
