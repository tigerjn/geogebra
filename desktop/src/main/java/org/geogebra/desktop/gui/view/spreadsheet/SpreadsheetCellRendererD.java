...
public class SpreadsheetCellRendererD extends DefaultTableCellRenderer {
	...
	private SpreadsheetTableInterface myTable;
	 ...
	 */
	public SpreadsheetCellRendererD(SpreadsheetTableInterface table) {
		this.myTable = table;
		...
		comboBox.setRenderer(new SpreadsheetDropDownCellRenderer());
	...
	public Component getTableCellRendererComponent(JTable table, Object value,
		...
		if (geo.doHighlighting()) {
			if (isCustomBGColor) {
				...
				bgColor = SpreadsheetTableD.SELECTED_BACKGROUND_COLOR;
			}
		}
	 ...
	 */
	public static class SpreadsheetDropDownCellRenderer extends DefaultListCellRenderer {
		private static final long serialVersionUID = 1L;
