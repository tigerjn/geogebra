 ...
 * 
 */
public class SpreadsheetCellEditorD extends DefaultCellEditor
	...
	protected SpreadsheetTableD table;
	 ...
	 */
	public SpreadsheetCellEditorD(Kernel kernel,
	...
	public Component getTableCellEditorComponent(JTable table0, Object value0,
		...
		if (table0 instanceof SpreadsheetTableD) {
			table = (SpreadsheetTableD) table0;
		} else {
			return null;
		}
