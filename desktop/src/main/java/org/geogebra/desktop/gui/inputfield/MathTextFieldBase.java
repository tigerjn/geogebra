 ...
 * 
 */
public class MathTextFieldBase extends JTextField
	 ...
	 */
	public MathTextFieldBase(AppD app) {
		super();
		this.app = app;
		initField();
	}
	 ...
	 */
	public MathTextFieldBase(AppD app, int columns) {
		super(columns);
		this.app = app;
		initField();
	}
