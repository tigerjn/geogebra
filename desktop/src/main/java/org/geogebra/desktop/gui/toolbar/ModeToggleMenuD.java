...
public class ModeToggleMenuD extends JPanel {
	...
	private final ToolbarToggleButton tbutton;
	private ToolbarToggleButton mouseOverButton;
	...
	public ModeToggleMenuD(AppD app, ToolbarD toolbar,
		...
		tbutton = new ToolbarToggleButton(this, toolbar, app);
	 ...
	 * @param bt button
	 */
	public void setMouseOverButton(ToolbarToggleButton bt) {
		mouseOverButton = bt;
		repaint();
	}
