...
public class InputBarHelpPanelD extends JPanel implements TreeSelectionListener,
	...
	private void createCommandTree() {
		...
		cmdTree.setCellRenderer(new CommandTreeCellRenderer());
	...
	private class CommandTreeCellRenderer extends DefaultTreeCellRenderer {
		...
		public CommandTreeCellRenderer() {
			update();
