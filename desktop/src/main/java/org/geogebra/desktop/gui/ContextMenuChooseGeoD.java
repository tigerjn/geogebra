...
public class ContextMenuChooseGeoD extends ContextMenuGeoElementD {
	...
	private void addGeo(GeoElement geo) {
		...
		mi.addMouseListener(new HiglightGeoMouseAdapter(geo));
	...
	private class HiglightGeoMouseAdapter extends MouseAdapter {

		private GeoElement geo;

		public HiglightGeoMouseAdapter(GeoElement geo) {
			this.geo = geo;
		}
