...
public class SpreadsheetTableD extends JTable implements FocusListener, SpreadsheetTable {
	private static final long serialVersionUID = 1L;

	private int tableMode = SpreadsheetTable.TABLE_MODE_STANDARD;
	...
	protected AppD app;
	protected SpreadsheetCellEditorD editor;
	private SpreadsheetCellEditorBoolean editorBoolean;
	private SpreadsheetCellEditorButton editorButton;
	private SpreadsheetCellEditorList editorList;
	...
	private ColumnMarginChangeListener columnModelListener;
	...
	private int selectionType = SpreadsheetTableInterface.CELL_SELECT;
	 ...
	 * Construct table
	 */
	public SpreadsheetTableD(SpreadsheetViewD view, DefaultTableModel tableModel) {
		super(tableModel);
		...
		editor = new SpreadsheetCellEditorD(kernel, getEditorController());
		...
		tableModel.addTableModelListener(new SpreadsheetTableModelListener());
		...
		columnModelListener = new ColumnMarginChangeListener();
	 ...
	 * one is created.
	 */
	public SpreadsheetCellEditorBoolean getEditorBoolean() {
		if (editorBoolean == null) {
			editorBoolean = new SpreadsheetCellEditorBoolean();
		}
	 ...
	 * created.
	 */
	public SpreadsheetCellEditorButton getEditorButton() {
		if (editorButton == null) {
			editorButton = new SpreadsheetCellEditorButton();
		}
		return editorButton;
	}
	 ...
	 * is created.
	 */
	public SpreadsheetCellEditorList getEditorList() {
		if (editorList == null) {
			editorList = new SpreadsheetCellEditorList();
		}
		return editorList;
	}
	...
	public class SpreadsheetTableModelListener implements TableModelListener {
	...
	public void selectAll() {
		setSelectionType(SpreadsheetTableInterface.CELL_SELECT);
	...
	public void selectionChanged() {
		...
		if (view.isTraceDialogVisible()) {
			...
			default:
			case SpreadsheetTableInterface.CELL_SELECT:
			...
			case SpreadsheetTableInterface.ROW_SELECT:
				newSelection.setCellRange(-1,
						getSelectionModel().getAnchorSelectionIndex(), -1,
						getSelectionModel().getLeadSelectionIndex());
				break;

			case SpreadsheetTableInterface.COLUMN_SELECT:
				newSelection.setCellRange(
						getColumnModel().getSelectionModel()
								.getAnchorSelectionIndex(),
		...
		if (changed) {
			...
			if (getTableMode() == SpreadsheetTable.TABLE_MODE_AUTOFUNCTION) {
	...
	public void setSelectionType(int selType0) {
		...
		if (view.isColumnSelect()) {
			selType = SpreadsheetTableInterface.COLUMN_SELECT;
		}
	...
	public void setRowSelectionInterval(int row0, int row1) {
		setSelectionType(SpreadsheetTableInterface.ROW_SELECT);
	...
	public void setColumnSelectionInterval(int col0, int col1) {
		setSelectionType(SpreadsheetTableInterface.COLUMN_SELECT);
	 ...
	 */
	public class ColumnMarginChangeListener
	...
	public void setTableMode(int tableMode) {
		...
		if (tableMode == SpreadsheetTable.TABLE_MODE_AUTOFUNCTION) {
		...
		else if (tableMode == SpreadsheetTable.TABLE_MODE_DROP) {
			// nothing to do (yet)
		}
