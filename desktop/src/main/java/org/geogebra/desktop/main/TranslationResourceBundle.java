...
public class TranslationResourceBundle extends PropertyResourceBundle {
	 ...
	 */
	public TranslationResourceBundle(InputStream in) throws IOException {
	...
	final public static ResourceBundle createBundle(String name,
			Locale locale) {
		TranslationResourceBundle bundle, temp = null;
	 ...
	 * @return created bundle
	 */
	public static TranslationResourceBundle loadSingleBundleFile(String name) {
		...
		try {
			InputStream in = TranslationResourceBundle.class
					.getResourceAsStream("/" + resourceName);
			TranslationResourceBundle ret = new TranslationResourceBundle(in);
			in.close();
			return ret;
		} catch (Exception e) {
