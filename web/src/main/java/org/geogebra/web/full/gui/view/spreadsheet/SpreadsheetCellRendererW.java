 ...
 */
public class SpreadsheetCellRendererW implements MouseDownHandler, MouseUpHandler {
	 ...
	 *            formatter
	 */
	public SpreadsheetCellRendererW(AppW app, SpreadsheetViewW view,
			SpreadsheetTableW table, CellFormat formatHandler) {
		this.app = app;
