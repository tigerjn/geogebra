...
public class Construction {
	...
	private HashMap<Integer, ArbitraryConstant> arbitraryConsTable = new HashMap<>();
	 ...
	 */
	public HashMap<Integer, ArbitraryConstant> getArbitraryConsTable() {
	...
	public void setArbitraryConsTable(
			HashMap<Integer, ArbitraryConstant> arbitraryConsTable) {
	...
	public GeoNumeric lookupConstantLabel(String label) {
		if (!getArbitraryConsTable().isEmpty()) {
			for (ArbitraryConstant arbConst : getArbitraryConsTable()
					.values()) {
