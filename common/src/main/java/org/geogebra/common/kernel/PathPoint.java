 ...
 */
public class PathPoint extends GPoint2D {
	 ...
	 *            segment type
	 */
	public PathPoint(double x, double y, SegmentType segmentType) {
		super(x, y);
	 ...
	 */
	public boolean isEqual(PathPoint point) {
	 ...
	 */
	public PathPoint barycenter(double t, PathPoint point2) {
		return new PathPoint((1 - t) * x + t * point2.x,
	...
	public PathPoint copy() {
		return new PathPoint(x, y, segmentType);
	}
	 ...
	 */
	public PathPoint withType(SegmentType returnType) {
		return new PathPoint(x, y, returnType);
	}
}
