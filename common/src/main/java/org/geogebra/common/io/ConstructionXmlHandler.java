...
/**
 * Processes geogebra.xml and geogebra_macro.xml files
 * @author Markus Hohenwarter
 */
public class ConstructionXmlHandler implements DocHandler {
	 ...
	 *            construction
	 */
	public ConstructionXmlHandler(Kernel kernel, Construction cons) {
		origKernel = kernel;
